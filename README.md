...
- **`rapport_controles_geo_as_point`** : Même rapport, toutes les géométries ramenées à un type point homogène pour une couche QGIS unique (voir `ARCHITECTURE_CONTROLES.md`)
...
│   │   └── rapport_controles_geo_as_point.sql
│   └── transformations/
│       ├── base/              # Tables base (23)
